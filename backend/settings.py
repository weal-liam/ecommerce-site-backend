...
from django.conf.global_settings import MEDIA_URL, MEDIA_ROOT, AUTH_USER_MODEL, SECURE_CONTENT_TYPE_NOSNIFF, \
    SECURE_SSL_REDIRECT, SESSION_COOKIE_SECURE, CSRF_COOKIE_SECURE, X_FRAME_OPTIONS, STATIC_ROOT
...
MIDDLEWARE = [
    ...
    'backend.middleware.RequestResponseLoggingMiddleware',
